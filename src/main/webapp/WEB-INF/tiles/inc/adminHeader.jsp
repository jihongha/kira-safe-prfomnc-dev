          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li <%if("notice".equals(subMenuCd) ){ %> class="active" <%} %> ><a href="/user/board/noticeLst.do">공지사항</a></li>
                <li <%if("dataRoom".equals(subMenuCd) ){ %> class="active" <%} %>><a href="/user/board/dataRoomLst.do">공개자료실</a></li>
                <li <%if("nesDta".equals(subMenuCd) ){ %> class="active" <%} %>><a href="/user/board/nesDtaLst.do">보도자료</a></li>
                <li <%if("qna".equals(subMenuCd) ){ %> class="active" <%} %>><a href="/user/board/qnaLst.do">Q&A</a></li>
              </ul>
            </li>
          </ul>
