...
function updateBppCmmnBoard(){
	location.href = "/user/board/newsDataEdit.do?bppCmmnBoardSeqNo="+bppCmmnBoardSeqNo;
}

function deleteBppCmmnBoard(){
	if (confirm("삭제하시겠습니까?") == true) {
		location.href = "/user/board/deleteBppCmmnBoardNewsData.do?bppCmmnBoardSeqNo="+bppCmmnBoardSeqNo;
	}
	else {
		return;
	}
...
<body>
	...
	<button type="reset" onclick="goNewsDataList()">목록</button>
